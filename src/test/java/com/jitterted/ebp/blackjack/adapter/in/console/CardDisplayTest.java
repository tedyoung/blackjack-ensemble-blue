...
class CardDisplayTest {
    ...
    public void displayNonTenCard() throws Exception {
        Card card = new DefaultCard(Suit.CLUBS, Rank.EIGHT);
    ...
    public void suitOfHeartsOrDiamondsIsDisplayedInRed() throws Exception {
        ...
        Card heartsCard = new DefaultCard(Suit.HEARTS, DUMMY_RANK);
        Card diamondsCard = new DefaultCard(Suit.DIAMONDS, DUMMY_RANK);
