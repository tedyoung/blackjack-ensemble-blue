...
public class HandDisplayTest {
    ...
    public void displayFirstCard() throws Exception {
        Hand hand = new Hand(List.of(new FaceUpCard(Suit.HEARTS, Rank.ACE)));
    ...
    public void cardsAsStringConvertsHandToString() throws Exception {
        Hand hand = new Hand(List.of(new FaceUpCard(Suit.CLUBS, Rank.TEN),
                                     new FaceUpCard(Suit.SPADES, Rank.FIVE)));
